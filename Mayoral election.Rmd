...
```{r}
OR1 <- OR %>% add_column("Labels" = c("Constant", "Median Age 2013", "% In employment 16-64", "Households Private Rented", "Dwellings in CT.bands F/G/H", "Turnout at Mayoral Election 2012", "Sadiq Aman Khan"), .before = "value")
